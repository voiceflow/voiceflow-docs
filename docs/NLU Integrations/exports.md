...
There is not necessarily 1:1 parity between the functionality you can design into an Assistant in Voiceflow and your NLU. In this guide, we can help identify how to best include the relevant data sets you’re looking to export for production in your designs using our existing feature sets, and work-arounds where required.

## What is the Export workflow?

When you have a Voiceflow Assistant design ready for export to an NLU, the workflow to get your data exported is:
