---
title: Intent and Entity Testing
excerpt: ''
deprecated: false
hidden: false
metadata:
...
Create your project, through scratch or the [NLU\_test\_v1.vf](https://github.com/voiceflow/nlu-testing-example/blob/master/examples/NLU_test_v1.vf)
