...
In Voiceflow, a dialogue state is assigned to a unique `userID`. This userID can be any string and is typically something unique that easily references the person on the session - such as an username, email, device ID, or phone number. (e.g. user54646, user@gmail.com, 1-647-424-4242, etc.). If you're not sure what to call it just for testing purposes, you can just pick a random `{userID}` like steve.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/58059d2-Screen_Shot_2022-02-27_at_9.24.52_AM.png",
        "Screen Shot 2022-02-27 at 9.24.52 AM.png",
        795
      ],
      "sizing": "80",
      "caption": "Global and Flow variables"
    }
  ]
}
[/block]
