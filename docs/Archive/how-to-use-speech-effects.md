---
title: How to use speech effects?
excerpt: ''
deprecated: false
hidden: true
metadata:
...
next:
  description: ''
---
How to use the break effect? How do I control the volume of my voice? How do I add effects to my voice?
...
![](https://files.readme.io/06765bd-image.png)
