  ...
  <div className="tico-form-wrapper">
    ...
    >
      <div className="tico-input-wrapper">
        <input className="tico-input" type="text" id="tico-message" name="tico-message" placeholder="Hey Tico! I need help with..." />
      ...
      <img className="tico-avatar-secondary" src="https://w17llroiln.ufs.sh/f/JH4JLc5mceYkdtNm8Jlpu1oeO8lNrvZq7mJiBcVy0XgAjEbS" />
    </form>

    <p class="tico-voiceflow">Powered by Voiceflow</p>
  </div>
</div>
