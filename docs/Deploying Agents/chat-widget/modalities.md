...
* A **law firm** may wish to have a text-only agent to ensure that all details collected are exactly what a user inputs and not subject to text-to-speech transcription.
