...
metadata:
  robots: index
---
Depending on your use-case, you might want to build **text** or **voice**-based conversational agents and embed them onto your website. Voiceflow's chat widget supports both modalities, and the same project will work with both.
