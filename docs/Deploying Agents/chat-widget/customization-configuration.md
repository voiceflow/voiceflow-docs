...
Below is a handy way to identify the user and share that info with your <<glossary:agent>>. If you pass a `userID`, the value will be set as the built-in {user_id} variable in your Voiceflow <<glossary:agent>>.
