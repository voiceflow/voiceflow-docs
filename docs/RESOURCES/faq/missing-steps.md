...
`With an additional example, an Amazon Alexa assistant will have specific step(s) such as Display or Directive whereas the 'Chat Assistant' type will not.`
