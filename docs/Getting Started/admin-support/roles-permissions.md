...
next:
  description: ''
---
_**How to set Workspace and Assistant-level permissions for your workspace members?**_
...
_Note: Owners are counted as a Workspace editor. Typically, the person who created the workspace is automatically assigned as an Owner. _
...
_Note: Editors can no longer invite new members to the Workspace_
...
1. _Assistant-level permissions only work if the user is a Viewer or Billing role on the Workspace. Owners, Admins, and Editors can’t be downgraded to the Assistant level as they have global edit privileges. _

2. _When you grant a Viewer Assistant-level access, they are counted as an Editor seat_