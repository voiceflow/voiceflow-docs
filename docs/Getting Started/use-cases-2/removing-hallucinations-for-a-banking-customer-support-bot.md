---
title: Removing hallucinations for a banking customer support agent
excerpt: ''
deprecated: false
hidden: false
metadata:
...
We rebuild a customer support banking agent for Wells Fargo. Using the knowledge base API and a series of crafted prompts, he removes hallucinations for the financial industry bot, which is highly regulated and data sensitive.
...
Follow along with our [template](https://creator.voiceflow.com/dashboard?import=656feb1d8e4aa90008722b04).
