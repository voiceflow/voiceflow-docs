...
***Note**:This step behaves and functions similarly to the [Choice](https://developer.voiceflow.com/v2.0/docs/choice) step, including associated features including Intent Editing/Creation Workflows, Scoping, previewing No Match/No Reply and many more!*
