...
1. **Select Capture Mode**: In the Capture Step editor, you'll see a toggle to choose between **Entities** and **Entire User Reply**. Select **Entire User Reply**.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/a38edb0cb24592a10afbaf3ad3e1c9e06205b8ab7b6cb201f33b6181c1e7ef71-CleanShot_2024-10-02_at_14.50.41.png",null,""],"align":"center"}]}[/block]
