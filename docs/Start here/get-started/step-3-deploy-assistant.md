...
next:
  description: ''
---
There are two main ways to launch a Voiceflow <<glossary:agent>>:
...
- The [Dialog Manager API](https://developer.voiceflow.com/reference/overview) can be used to send input to your Voiceflow <<glossary:agent>> and fetch a response based on your design. This API can also manage the state of your user's conversation, letting them leave the conversation then pick it up later from the same spot.
