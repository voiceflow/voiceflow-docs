---
title: Conversational AI Key Concepts
...
A "codebase" for a Voiceflow application. Each _Project_ is made up of NLU training, response and logic data. Response and logic data are represented by flows, topics and components.
