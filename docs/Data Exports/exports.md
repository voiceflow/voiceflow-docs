...
next:
  description: ''
---
Voiceflow is an NLU-agnostic <<glossary:agent>> design and development platform. Because of that, you can design any of the core data types required to build a functional agent and dialogue manager directly with the tools available on your design campus.
...
You can categorize a Voiceflow <<glossary:agent>> into three primary data sets:
