...
3. In the Bot app feature page, you should Select an existing bot and select the bot you want to use
...
7. In Teams apps > Manage apps > Hello Voiceflow, click Publish to complete the publishing process.

   1. The publishing process takes some time until the changes come into effect, e.g, 1-2 minutes, while the admin centre remarks that sometimes updates can take hours.
