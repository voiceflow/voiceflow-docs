...
> **Example:** For `Get contact`, you might provide an LLM description such as `Retrieve details of a customer when they mention their email address in the conversation`.
...
> Yes. When using **Update contact**, **Update deal**, or **Update company**, you can pass multiple properties in a single request.
